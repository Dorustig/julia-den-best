...
async function sendWelcomeEmail({ to, naam, magicLink, loginUrl, email, password }) {
  ...
  if (email && password) {
    const body = `
      ...
      <div style="background:#faf4ea;border:1px solid #dcb9b4;border-radius:12px;padding:16px 20px;margin:16px 0;font-family:'SF Mono',Menlo,monospace;font-size:14px;color:#5c4632;line-height:1.8;">
