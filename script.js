...
const T = {
    nl: {
        ...
        modalSub: 'Je hebt het formulier ingevuld. Mijn team en ik gaan jouw antwoorden handmatig bekijken.',
        modalReminderStrong: 'Houd je SMS en WhatsApp in de gaten',
        modalReminderSpan: 'daar nemen wij contact met je op.',
        modalCTA: 'Stuur beschikbaarheid',
        modalDisclaimer: 'We nemen binnen 24 uur contact met je op om je kennismakingsgesprek in te plannen.',
    ...
    en: {
        ...
        modalSub: "You submitted the form. My team and I will personally review your answers.",
        modalReminderStrong: 'Keep an eye on your SMS and WhatsApp',
        modalReminderSpan: "that's how we'll reach out.",
        modalCTA: 'Share availability',
        modalDisclaimer: "We'll contact you within 24 hours to schedule your intro call.",
